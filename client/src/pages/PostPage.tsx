...
const PostPage = () => {
  ...
  return (
    <div className="px-4 ">
      ...
      <div className="pb-2">
        <div
          className={`border-1 rounded-2xl ${borderColor}`}
        ...
        >
          ...
          <section className={`p-4 ${borderColor} border-b-1`}>
            ...
            <section>
              <textarea
                className={`${
                  reply.length > 255 ? "text-red-400" : textColor
                } focus:outline-none p-2 resize-none w-full placeholder:text-gray-400`}
                placeholder="Reply"
                value={reply}
                onChange={(e) => {
              ...
              <div className={`flex justify-end items-center gap-x-4 pb-1`}>
                ...
                <button
                  className={`flex justify-center items-center border-1 ${borderColor} rounded-xl p-1 ${textColor} w-12
                              ${
                                reply.length > 255 || reply.length == 0
                                  ? ""
          ...
          <div className="text-gray-400 text-center" ref={commentLoader}>
